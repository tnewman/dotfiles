...
pacstrap /mnt amd-ucode base base-devel intel-ucode kate konsole firefox fuse fwupd git \
    networkmanager noto-fonts noto-fonts-emoji openssh packagekit-qt5 plasma reflector sddm \
    sudo ttf-dejavu ttf-croscore ttf-liberation ufw
