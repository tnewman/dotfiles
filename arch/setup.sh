...
pacstrap /mnt amd-ucode base base-devel chromium dolphin intel-ucode kate konsole firefox \
    fuse fwupd git libnotify networkmanager noto-fonts noto-fonts-emoji openssh packagekit-qt5 \
